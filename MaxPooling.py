        ...
        for d in range(self.input_shape[2]):
            ...
            for w in range(output_width):
                 ...
                 for h in range(output_hieght):
                    ...
                    self.output[w,h,d] = input[w*self.stride:w*self.stride + self.window[0], h*self.stride: h*self.stride + self.window[1],d] .max()
        ...
        for d in range(self.input_shape[2]):
            ...
            for w in range(self.input_shape[0]):
                 ...
                 for h in range(self.input_shape[1]):
                    ...
                    backprop[w*self.window[0]:w*self.stride + self.window[0], h*self.stride: h*self.stride + self.window[1],d] = output_grad[w:w+1,h:h+1,d] * (self.output[w:w+1,h:h+1,d] == self.input[w*self.stride:w*self.stride + self.window[0], h*self.stride: h*self.stride + self.window[1],d] .max())
            return backprop
